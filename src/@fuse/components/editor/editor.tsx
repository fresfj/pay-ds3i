  ...
  (
    ...
    return (
      <Portal disablePortal={!fullScreen}>
        ...
        <Stack className={clsx('w-full overflow-hidden rounded-4', className)} sx={{ ...(!editable && { cursor: 'not-allowed' }), ...slotProps?.wrap }}>
          <StyledRoot
            error={!!error}
            disabled={!editable}
          ...
          >
            ...
            <EditorContent
              ...
              autoCapitalize="off"
              editor={editor}
              className={clsx('pt-12', editorClasses.content.root)}
            />
          </StyledRoot>
