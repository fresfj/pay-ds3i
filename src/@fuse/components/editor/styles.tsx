...
export const StyledRoot = styled(Stack, {
  ...
  border: `solid 1px ${varAlpha(theme.palette.grey['500Channel'], 0.2)}`,
  scrollbarWidth: 'thin',
  ...
  [`& .${editorClasses.content.root}`]: {
    ...
    '& .tiptap': {
      ...
      [`& .${editorClasses.content.blockquote}`]: {
        ...
        borderLeft: `solid 8px ${varAlpha(theme.palette.grey['500Channel'], 0.08)}`,
      ...
      [`& .${editorClasses.content.codeBlock}`]: {
        ...
        [`& .${editorClasses.content.langSelect}`]: {
          ...
          borderColor: varAlpha(theme.palette.grey['500Channel'], 0.08),
          backgroundColor: varAlpha(theme.palette.grey['500Channel'], 0.08),
        },
      },
    },
