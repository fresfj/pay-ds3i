...
import { isExternalLink } from '@fuse/hooks/utils';
import { NavSectionProps } from '../nav-section';
import { Label } from '../label';
import { Iconify } from '../iconify';
import { Scrollbar } from '../scrollbar';
import useEventListener from '@fuse/hooks/useEventListener';
...
import { useGetShopProductsQuery } from 'src/app/main/apps/shop/ShopApi';
  ...
  const renderButton = (
    <Box
      ...
      sx={{
        ...
        borderRadius: { sm: 1.5 },
        cursor: { sm: 'pointer' },
        bgcolor: { sm: varAlpha(theme.palette.grey['500Channel'], 0.08) },
        ...sx,
      }}
      {...other}
    >
