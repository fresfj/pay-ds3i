...
function Impressions() {
	...
	const widget = useSelector(selectWidget<ImressionsWidgetType>('newUsers'));
	...
	return (
		<Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden">
			<div className="flex items-start justify-between m-24 mb-0">
				<Typography className="text-lg font-medium tracking-tight leading-6 truncate">New Users</Typography>
				<div className="ml-8">
					<Chip
						size="small"
