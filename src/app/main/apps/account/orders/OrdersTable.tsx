...
import { selectFilteredOrders, useGetAccountsOrdersQuery } from '../AccountApi';
...
function OrdersTable(props: OrdersTableProps) {
	...
	const { data, isLoading } = useGetAccountsOrdersQuery(user);
	...
	function handleClick(item: EcommerceOrder) {
		navigate(`/apps/account/orders/${item.id}`);
	}
