...
import { EcommerceCoupon, EcommerceProduct, selectFilteredCoupons, useGetECommerceCouponsQuery } from '../ECommerceApi';
...
function CouponsTable(props: CouponsTableProps) {
	...
	const { data, isLoading } = useGetECommerceCouponsQuery();
	...
	function handleClick(item: EcommerceCoupon) {
		navigate(`/apps/e-commerce/coupons/${item.id}/${item.code}`);
	}
