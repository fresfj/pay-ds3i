...
import { useDeleteECommerceCouponsMutation, useDeleteECommerceProductsMutation } from '../ECommerceApi';
...
function ProductsTableHead(props: ProductsTableHeadPropsType) {
	...
	const [removeCoupons] = useDeleteECommerceCouponsMutation();
						...
						>
							...
							>
								<MenuList>
									<MenuItem
										onClick={() => {
											removeCoupons(selectedProductIds);
											onMenuItemClick();
