...
Queria te indicar um serviço que estou achando bem prático. É a Creabox, uma assinatura de creatina que entrega sempre na porta de casa. Tem me ajudado a manter a rotina dos treinos e sempre vem com uns brindes legais junto.

Tenho um cupom de desconto caso você queira experimentar!

Você já ganha 5% de desconto ao acessar este link: [link de indicação].
...
export function ShareDialog({
  ...
  const sendMessages = async (data) => {
    try {
      await axios.post('https://webhook2.richeli.dev/webhook/sendMessage', data)
