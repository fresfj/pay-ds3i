...
import { Carousel, CarouselArrowNumberButtons, CarouselThumb, CarouselThumbs, useCarousel } from '@fuse/components/carousel';
import { Lightbox, useLightBox } from '@fuse/components/lightbox';
...
export function ProductDetailsCarousel({ images }: Props) {
  ...
  const slides = images?.map((img: any) => ({ src: img.url })) || [];
